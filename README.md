# OCEAN 506B JupyterHub image

Docker image for RStudio notebook using jupyter-rsession-proxy to handle auth flow with JupyterHub. Rstudio version is v2026.01.1+403, and R version is 4.5.3.

- Built docker image can be found at https://hub.docker.com/r/winghouw/ocean506b
- Most Recent built docker image can be found at https://quay.io/repository/winghouw/ocean506b
